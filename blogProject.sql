...
CREATE TABLE `commentToPost` (
  ...
  `postID` int(11) DEFAULT NULL,
  `commenterName` varchar(50) COLLATE latin1_general_ci DEFAULT 'Anonymous',
...
(319, 'TESTING TESTING', 'NDIWNICW', 'DCWNCWI', '2008-09-08', NULL, NULL, NULL),
(320, 'this is the title', 'this should be post description', 'And this should be the content', '2019-04-27', NULL, NULL, NULL);
...
--
ALTER TABLE `commentToPost`
  MODIFY `commentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=600;
...
--
ALTER TABLE `post`
  MODIFY `postID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=321;
