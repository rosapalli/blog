...
select post.userID, post.postID, post.postTitle,post.postDescription, post.postContent, post.postDate, GROUP_CONCAT(categoryType) AS categoryType
FROM category_post
LEFT JOIN post
ON category_post.postID = post.postID
LEFT JOIN category
...
(336, 'test', 'test', '&#60;ol&#62;&#60;li&#62;test&#60;/li&#62;&#60;li&#62;test&#60;/li&#62;&#60;li&#62;test&#60;/li&#62;&#60;/ol&#62;', '2019-05-03', NULL, NULL, NULL);
